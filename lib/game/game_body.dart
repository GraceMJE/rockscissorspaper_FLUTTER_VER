...
import 'package:rockscissorspaper/game/widget/cpu_input.dart';
import 'package:rockscissorspaper/game/widget/game_result.dart';
import 'package:rockscissorspaper/game/widget/user_input.dart';
...
class _GameBodyState extends State<GameBody> {
  ...
  // cpu가 가위바위보 중에 낼 것을 랜덤으로 정해주는 함수
  void setCpuInput() {
    final random = Random();
